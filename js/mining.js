...
const MINING_MACHINES = [
    { id: 1, name: 'Basic Miner', cost: 0.001, boost: 2, owned: 0, currency: 'tBNB' },
    { id: 2, name: 'Advanced Miner', cost: 0.005, boost: 12, owned: 0, currency: 'tBNB' },
    { id: 3, name: 'Pro Miner', cost: 0.02, boost: 60, owned: 0, currency: 'tBNB' },
    { id: 4, name: 'Mega Miner', cost: 0.1, boost: 400, owned: 0, currency: 'tBNB' }
];
