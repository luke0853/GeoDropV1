// Firebase GeoBoard Translations Setup Script
// This script creates the GeoBoard translations in Firebase
...
// Function to create GeoBoard translations in Firebase
async function createGeoBoardTranslations() {
  try {
    console.log('🚀 Creating GeoBoard translations in Firebase...');
    
    // Create geoboard document in translations collection
    await setDoc(doc(db, 'translations', 'geoboard'), geoboardTranslations);
    
    console.log('✅ GeoBoard translations created successfully!');
    console.log('📁 Collection: translations');
    console.log('📄 Document: geoboard');
    console.log('🌍 Languages: de, en');
    console.log('📊 Tabs: GeoBoard, Colloseum, Referrals');
    
  } catch (error) {
    console.error('❌ Error creating GeoBoard translations:', error);
  }
}

// Run the setup
createGeoBoardTranslations();
