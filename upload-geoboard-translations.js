// Upload GeoBoard Translations to Firebase
// This script uploads the translations directly to Firebase

// Import Firebase (using the same version as the app)
...
const firebaseConfig = {
  ...
  authDomain: "geodropv1.firebaseapp.com",
  projectId: "geodropv1",
  storageBucket: "geodropv1.appspot.com",
...
async function uploadTranslations() {
  try {
    ...
    await setDoc(doc(db, 'translations', 'colloseum'), colloseumTranslations);
    console.log('✅ Colloseum tab uploaded');
    
    await setDoc(doc(db, 'translations', 'referrals'), referralsTranslations);
